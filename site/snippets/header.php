...
<head>
  ...
  <link rel="preload" href="<?= url('assets/fonts/Geist[wght].ttf') ?>" as="font" type="font/ttf" crossorigin="anonymous">
  <link rel="preload" href="<?= url('assets/fonts/Geist-Italic[wght].ttf') ?>" as="font" type="font/ttf" crossorigin="anonymous">
  ...
  <?php if($page->id() === 'home'): ?>
    ...
    <?php endif; ?>
  <?php else: ?>
    <title><?php if($page->uri() == 'home'): ?><?= $site->title() ?><?php else: ?><?= $site->title() ?> – <?= $page->title() ?><?php endif; ?></title>
